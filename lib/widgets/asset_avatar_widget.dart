...
class AssetAvatarWidget extends StatelessWidget {
  final String image;
  final ValueChanged<ImageSource> onClicked;
  const AssetAvatarWidget(
  ...
  Widget build(BuildContext context) {
    ...
    final avatar =
        AvatarClass(assetImage: this.image, onClicked: this.onClicked);
    return Center(
        child: Stack(
      children: [
        avatar.buildAssetImage(context),
