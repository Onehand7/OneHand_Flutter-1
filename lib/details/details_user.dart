      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
            ...
            onTap: (){
              Navigator.push(context,Animation_route (ListUser())).whenComplete(() => Navigator.of(context).pop());
            },
          ),
          SizedBox(width: 10),
        ],
...
class DetailsFormState extends State<Details>{
  ...
  Container _getBackground(){
    return Container(
      child: Image.network("https://www.urgencias24h.net/wp-content/uploads/2019/12/electricista-urgente-24h-nou-barris-barcelona.jpg",
        fit: BoxFit.cover,
        height: 300.0,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Separator(),
                Text("Mi nombre es ${_doc.nombre} ${_doc.apellido} soy de Honduras La Ceiba y soy Programador"
